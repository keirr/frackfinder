/**
 * Created by keir on 10/26/16.
 */

// frackfinder Finder results page
...
var xhr = $.getJSON(url + "app?short_name=frackfinder"); // In this case frack finder
var app_id;
...
// Function to populate the arcs with data from frackfinder App
function create_arcs(formTaskId) {
    ...
    img.done(function(data){
        // Load the _b size and not the _m size from Frack
        //var url = data.info.url_m.replace("_m.jpg","_b.jpg");
        $("#frack").attr("src",data.info.url_b);
    });
